...
function Card({filterCat}) {
    ...
    useEffect(() => {
        ...
        return () => {
          clearTimeout(timer); // Cleanup the timer if the component unmounts before it fires
        };
      },[]);
  ...
  return (
    <div style = {{display:'flex',flexWrap:'wrap'}} className='cards'>
            ...
            Loading?
                    ...
                    <Catergory catergory = {data[filterCat]}></Catergory> 
                    :
                    <Catergory catergory = {CourseData}></Catergory>
                    )
                :
                <Spinner></Spinner>
        }          
